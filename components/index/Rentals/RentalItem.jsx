...
export default function RentalItem({ reverse, content, title, image, icons }) {
  ...
  return (
    <div
      className="grid grid-cols-1 md:grid-cols-2 place-content-center gap-2 my-10 lg:my-[5.5rem]"
    
    >
      <div className="grid grid-cols-2 gap-5 grid-flow-row place-content-center">
      ...
      <div className={classOrder}>
        <img
          src={image}
          className="object-contain img-float h-80"
          alt="Card"
        />
      </div>
    </div>
